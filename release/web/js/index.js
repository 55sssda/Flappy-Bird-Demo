(function () {
    let config = JSON.parse(`{"resolution":{"designWidth":750,"designHeight":1624,"scaleMode":"fixedauto","screenMode":"vertical","backgroundColor":"rgba(255, 255, 255, 1)","alignV":"top","alignH":"left"},"2D":{"useRetinalCanvas":true,"FPS":60,"isAntialias":true,"isAlpha":false,"webGL2D_MeshAllocMaxMem":true,"defaultFont":"SimSun","defaultFontSize":20},"physics2D":{"debugDraw":true,"drawCenterOfMass":true,"allowSleeping":true,"gravity":{"x":0,"y":9.8},"velocityIterations":8,"positionIterations":3,"pixelRatio":50,"drawShape":true,"drawJoint":true,"drawAABB":false},"splash":{"fit":"center","enabled":true,"duration":1},"3D":{"enableDynamicBatch":true,"defaultPhysicsMemory":16,"enableUniformBufferObject":true,"pixelRatio":1,"enableMultiLight":true,"maxLightCount":32,"lightClusterCount":{"x":12,"y":12,"z":12},"maxMorphTargetCount":32},"physics3D":{"fixedTimeStep":0.016666666666666666,"maxSubSteps":1,"enableCCD":false,"ccdThreshold":0.0001,"ccdSphereRadius":0.0001},"physics3dModule":"laya.bullet","physics2dModule":"laya.box2D","spineVersion":"3.8","stat":false,"vConsole":false,"alertGlobalError":false,"pkgs":[{"path":""}]}`);
