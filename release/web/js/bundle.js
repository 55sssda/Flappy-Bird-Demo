...
(() => {
  ...
  // src/view/background/background.ts
  var _animate, animate_fn;
  var background = class {
    constructor(...url) {
      __privateAdd(this, _animate);
      ...
      this.init();
      Laya.timer.frameLoop(1, this, __privateMethod(this, _animate, animate_fn));
    }
    getTimeStatus() {
      return (/* @__PURE__ */ new Date()).getHours() < 18 ? "0" : "1";
    }
    init() {
  ...
  // src/view/progress/text.ts
  var progressText = class {
    constructor() {
      this.text = null;
  ...
  var _updatePropTweens = function _updatePropTweens2(tween, property2, value, start, startIsRelative, ratio, time, skipRecursion) {
  ...
  var _setterFuncWithParam = function _setterFuncWithParam2(target, property2, value, data) {
  ...
  var _setterWithModifier = function _setterWithModifier2(target, property2, value, data) {
  ...
  var _setterScaleWithRender = function _setterScaleWithRender2(target, property2, value, data, ratio) {
    var cache = target._gsap;
    cache.scaleX = cache.scaleY = value;
    cache.renderTransform(ratio, cache);
  };
  var _setterTransformWithRender = function _setterTransformWithRender2(target, property2, value, data, ratio) {
    var cache = target._gsap;
  ...
  var _convertToUnit = function _convertToUnit2(target, property2, value, unit) {
    var curValue = parseFloat(value) || 0, curUnit = (value + "").trim().substr((curValue + "").length) || "px", style = _tempDiv.style, horizontal = _horizontalExp.test(property2), isRootSVG = target.tagName.toLowerCase() === "svg", measureProperty = (isRootSVG ? "client" : "offset") + (horizontal ? "Width" : "Height"), amount = 100, toPixels = unit === "px", toPercent = unit === "%", px, parent, cache, isSVG;
    ...
    parent = ~property2.indexOf("adius") || unit === "em" && target.appendChild && !isRootSVG ? target : target.parentNode;
    if (isSVG) {
  ...
  // src/view/title/title.ts
  var title = class {
    constructor(res) {
      const title2 = new Laya.Box();
      title2.texture = res.url;
      title2.anchorX = 0.5;
      title2.anchorY = 0.5;
      title2.width = Laya.stage.width / 1.2;
      title2.height = Laya.stage.width / 6;
      title2.x = Laya.stage.width / 2;
      title2.y = Laya.stage.height / 5;
      title2.scaleX = 0;
      title2.scaleY = 0;
      Laya.stage.addChild(title2);
      Laya.stage.getChildByName("root").getChildByName("Scene2D").title = title2;
      gsapWithCSS.to(title2, { scaleX: 1.2, scaleY: 1.2, duration: 0.3, onComplete() {
        gsapWithCSS.to(title2, { scaleX: 0.8, scaleY: 0.8, duration: 0.3, onComplete() {
          gsapWithCSS.to(title2, { scaleX: 1, scaleY: 1, duration: 0.3 });
        } });
      } });
    }
  };
  ...
  // src/view/playBtn/playBtn.ts
  var playBtn = class {
    constructor(assets2) {
      const play = new Laya.Image();
      play.texture = assets2.url;
    ...
    hide() {
      const title2 = Laya.stage.getChildByName("root").getChildByName("Scene2D").title;
      const play = Laya.stage.getChildByName("root").getChildByName("Scene2D").play;
      const shareBtn2 = Laya.stage.getChildByName("root").getChildByName("Scene2D").shareBtn;
      Laya.Tween.to(title2, { scaleX: 0.9, scaleY: 0.9 }, 150, Laya.Ease.linearIn, Laya.Handler.create(this, () => {
        Laya.Tween.to(title2, { y: -1 * title2.y }, 150, Laya.Ease.linearIn, Laya.Handler.create(this, () => {
          Laya.stage.removeChild(title2);
      ...
      Laya.Tween.to(shareBtn2, { y: shareBtn2.y * 2 }, 300, Laya.Ease.linearIn, Laya.Handler.create(this, () => {
        Laya.stage.removeChild(shareBtn2);
      }));
    }
  };

  // src/view/shareBtn/shareBtn.ts
  var shareBtn = class {
    constructor(item) {
      this.userdata = [
        {
  ...
  var assets = [
    ...
    "resources/bird1_0.png",
    //12
    "resources/bird1_1.png",
    //13
    "resources/bird1_2.png",
    //14
    "resources/bird2_0.png",
    //15
    "resources/bird2_1.png",
    //16
    "resources/bird2_2.png",
    //17
  ...
  // src/view/init/hook/bird.ts
  var { regClass, property } = Laya;
  var bird = class extends Laya.Script {
  ...
  __decorateClass([
    property(String)
  ], bird.prototype, "onAwake", 1);
  bird = __decorateClass([
    regClass("BdGEuMvbQZ-YR5iB8dEGwA")
  ], bird);

  // src/view/init/init.ts
  var init4 = class {
    ...
    initGame(birdTexture1, birdTexture2, footerTexture, tipsTexture, fractionList, pipeList, readyText, overText, pause, resume) {
      ...
      const bird2 = new Laya.Animation();
      bird2.startTap = -1;
      bird2.loadImages([skin[0].url, skin[1].url, skin[2].url]);
      bird2.index = 0;
      bird2.loop = true;
      bird2.autoPlay = true;
      bird2.autoSize = true;
      bird2.y = Laya.stage.height * 0.3;
      bird2.anchorX = 0.5;
      bird2.anchorY = 0.5;
      bird2.scaleX = 2;
      bird2.scaleY = 2;
      bird2.addComponent(bird);
      bird2.on(Laya.Event.TRIGGER_ENTER, (e) => {
        if (e.owner.nodeType == "1") {
          ...
          card.scaleY = 0.75;
          mask.addChild(card);
          Laya.Tween.to(card, { alpha: 1, scaleX: 1, scaleY: 1 }, 100, Laya.Ease.linearIn, Laya.Handler.create(this, () => {
            Laya.timer.pause();
          }));
      ...
      bird2.birdRigidBody = bird2.addComponent(Laya.RigidBody);
      bird2.birdRigidBody.type = "static";
      bird2.birdRigidBody.allowSleep = false;
      bird2.birdCollider = bird2.addComponent(Laya.CircleCollider);
      bird2.birdCollider.radius = bird2.width / 3.5;
      bird2.birdCollider.restitution = 0.5;
      Laya.stage.getChildByName("root").getChildByName("Scene2D").bird = bird2;
    ...
    startGame() {
      const bird2 = Laya.stage.getChildByName("root").getChildByName("Scene2D").bird;
      ...
      Laya.stage.addChild(bird2);
      Laya.stage.addChild(footer);
      Laya.stage.addChild(btn);
      bird2.x = bird2.width * -1;
      Laya.Tween.to(bird2, { x: 120 }, 650, Laya.Ease.linearIn, Laya.Handler.create(this, () => {
        ...
        this.alpha(ready);
        Laya.stage.on("click", () => {
          bird2.birdRigidBody.type = "dynamic";
          if (bird2.startTap == -1) {
            Laya.stage.removeChild(tips);
            Laya.stage.removeChild(ready);
            Laya.timer.once(0, this, this.createPipe);
            Laya.timer.loop(7e3, this, this.createPipe);
          }
          let direction = new Laya.Vector2(bird2.x, bird2.y);
          let force = new Laya.Vector2(0, -250);
          bird2.birdRigidBody.applyForce(direction, force);
          bird2.startTap++;
        });
      }));
    ...
    createPipe() {
      const bird2 = Laya.stage.getChildByName("root").getChildByName("Scene2D").bird;
      const footer = Laya.stage.getChildByName("root").getChildByName("Scene2D").footer;
      let pipe3 = this.getType() == "1" ? [this.pipeList[2], this.pipeList[3]] : [this.pipeList[0], this.pipeList[1]];
      ...
      Box.y = 0;
      const maxLength = bottomDot - bird2.height * 4;
      const downPipe = new Laya.Sprite();
      downPipe.nodeType = "0";
      downPipe.texture = pipe3[0];
  ...
  var Loading = class extends LoadingBase {
    onAwake() {
      Laya.loader.load(["resources/progress.png", "resources/progress$bar.png", "resources/bg_day.png", "resources/bg_night.png", "resources/title.png"]).then((res) => {
        let bg = new background_default(res[2], res[3]);
        new progress_default(res[0], res[1]);
        let progressObject = new progressText();
        new title_default(res[4]);
        bg.animate = true;
        Laya.loader.load(assets_default, Laya.loader.IMAGE, (p) => {
  ...
  Loading = __decorateClass([
    regClass2("y8koOUIIT9a6ouRQ0cVrLw")
  ], Loading);
})();
